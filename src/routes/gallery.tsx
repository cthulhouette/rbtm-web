    ...
    <PublicLayout>
      <section className="bg-ink text-background">
        <div className="container-x py-20 md:py-28">
          <div className="text-[10px] uppercase tracking-[0.3em] text-beige mb-4">Gallery</div>
          <h1 className="text-4xl md:text-6xl text-background max-w-3xl">Inside the mill.</h1>
        </div>
      </section>
        ...
        <div className="container-x">
          ...
          {items && items.length === 0 && (
            <p className="text-background/60 text-sm uppercase tracking-[0.18em]">
              No gallery items yet. Add them from the admin portal.
            </p>
          )}
